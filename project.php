	                	...
	                	?>
                            <div class="projectcall">
                                <ul class="actions uniform">
                                    ...
                                    echo "<li><a href='$urlcliente' class='button'  target='_blank'>Visitar Projeto</a></li>";
                                    ?>
                                </ul>
                            </div>
						</div>
			...
			<section id="two" class="main style2 special">
                ...
                <div id="portfolio">
					...
					<?php
	                  ...
	                  $url=$dados['p_thumb'];
                      $titulo=$dados['p_tit'];
	                  echo '<li><a href="project.php?id='.$dados['p_id'].'"/><img src="images/'.$url.'" alt="'.$dados['p_tit'].'"> <div><h3>'.$dados['p_tit'].'</h3><br></div></a></li>';
	                  ...
	                  $url=$dados['p_thumb'];
                      $titulo=$dados['p_tit'];
	                  echo '<li><a href="project.php?id='.$dados['p_id'].'"/><img src="images/'.$url.'" alt="'.$dados['p_tit'].'"> <div><h3>'.$dados['p_tit'].'</h3></div></a></li>';
